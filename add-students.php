...
if (strlen($_SESSION['alogin'])=="") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql="INSERT INTO  students(name,rollno,email,gender,class,dob) 
                VALUES(:name,:rollno,:email,:gender,:class,:dob)";
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="rollno" class="form-control" id="rollid"
                                                        required="required" autocomplete="off">
                                                </div>
                                            </div>
