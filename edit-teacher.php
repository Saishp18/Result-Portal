...
if (strlen($_SESSION['alogin'])=="") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql="update teachers set name=:name, email=:email, dept=:dept where id=:id ";
                ...
                <div class="main-page">
                    ...
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Edit Teacher's info </h2>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            $sql = "SELECT T.id, T.name, T.email, D.name AS deptname, D.id AS deptid FROM TEACHERS AS T JOIN DEPARTMENTS AS D ON T.dept = D.id WHERE T.id = :id";
                                                $query = $dbh->prepare($sql);
                                                $query->bindParam(':id', $id, PDO::PARAM_STR);
                                                $query->execute();
