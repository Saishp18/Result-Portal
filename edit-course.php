...
if (strlen($_SESSION['alogin'])=="") {
    ...
    if (isset($_POST['Update'])) {
        ...
        $sql="update courses set name=:coursename,code=:coursecode, department=:department where id=:sid";
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            <?php        
                                                // echo $coursecode.$coursename.$department;
                                                $sid=intval($_GET['courseid']);
                                                $sql = "SELECT c.id, c.name, c.code, d.name as deptname, d.id as deptid from courses as c join departments as d on c.department=d.id where c.id=:sid";
                                                $query = $dbh->prepare($sql);
                                                $query->bindParam(':sid', $sid, PDO::PARAM_STR);
                                                $query->execute();
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Course ID</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="courseid"
                                                        value="<?php echo htmlentities($result->id); ?>"
                                                        class="form-control" id="default" required="required" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="coursename"
                                                        ...
                                                        class="form-control" id="default" placeholder="Course Name"
                                                        required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="coursecode" class="form-control"
                                                        value="<?php echo htmlentities($result->code); ?>" id="default"
