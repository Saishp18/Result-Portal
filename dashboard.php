                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat bg-primary" href="manage-students.php">
                                        ...
                                        <span class="number"><?php echo htmlentities($totalstudents); ?></span>
                                        <span class="name">Students</span>
                                        <span class="bg-icon"><i class="fa fa-user-graduate"></i></span>
                                    </a>
                                    <!-- /.dashboard-stat -->
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat bg-danger" href="manage-teachers.php">
                                        ...
                                        <span class="bg-icon"><i class="fas fa-chalkboard-teacher"></i></span>
                                    </a>
                                    <!-- /.dashboard-stat -->
                                </div>
                                <!-- /.col-lg-3 col-md-3 col-sm-6 col-xs-12 -->
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <a class="dashboard-stat bg-success" href="manage-courses.php">
                                        <?php
                                        $sql3="SELECT  distinct id from  courses ";
