                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            ...
                                            $query = "SELECT * FROM STUDENT AS S JOIN CLASSES AS C ON S.CLASS=C.ID WHERE S.rollno=:rollno and S.email=:email and S.class=:class";
                                                ...
                                                <table class="table table-hover table-bordered" border="1" width="100%">
                                                    <thead>
                                                        <tr style="text-align: center">
                                                            ...
                                                            <th style="text-align: center">Marks
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
            ...
            ?>
                                                    ...
                                                    $totlcount+=$totalmarks;
                                                        ...
                                                        <div class="alert alert-warning left-icon-alert" role="alert">
                                                            <strong>Notice!
                                                            </strong> Your result not declare yet
                                                            <?php } ?>
                                                        </div>
                                                        <?php
} else {?>
