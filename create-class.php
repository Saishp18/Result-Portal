...
if (strlen($_SESSION['alogin'])=="") {
    header("Location: index.php");
        ...
        if (isset($_POST['submit'])) {
            ...
            $year=$_POST['year'];
            $dept=$_POST['dept'];
            // echo $classname." -  ".$year."  -  ".$dept;
            $sql="INSERT INTO  classes(classname, year, dept) VALUES(:classname,:year,:dept)";
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <input type="text" name="classname" class="form-control"
                                                            placeholder="For eg. TE-IT" required="required"
                                                            id="success">
                                                    </div>
                                                </div>
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <input type="number" name="year" required="required"
                                                            placeholder="For eg. 2020" class=" form-control"
                                                            id="success">
                                                    </div>
                                                </div>
