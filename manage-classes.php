                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li>Classes</li>
                                    <li class="active"><a href="manage-classes.php">Manage Classes</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel">
                                        ...
                                        <?php if ($msg) {?>
                                        <div class="alert alert-success left-icon-alert" role="alert"> <strong></strong>
                                            ...
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo htmlentities($result->classname); ?></td>
                                                        <td>
                                                            <?php echo htmlentities($result->year); ?></td>
                                                        <td>
