...
if (strlen($_SESSION['alogin'])=="") {
    ...
    if (isset($_POST['submit'])) {
        ...
        echo $deptname." ".$deptcode;
        $sql="INSERT INTO  departments(name, code) VALUES(:deptname,:deptcode)";
...
<head>
    ...
    <title>SRMS Admin Add Department</title>
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <input type="text" name="deptname" class="form-control"
                                                            placeholder="For eg. Information Technology"
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <input type="text" name="deptcode" required="required"
                                                            placeholder="For eg. IT" class="form-control" id="success">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group has-success">
                                                    <div class="">
                                                        <button type="submit" name="submit"
                                                            class="btn btn-success btn-labeled">Submit
